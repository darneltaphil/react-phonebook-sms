...
import { VALIDATOR_EMAIL, VALIDATOR_MAXLENGTH } from "../Utils/Validators";
                ...
                <div className="col-lg-6">
                  <div className="p-5">
                    <div className="text-center">
                      <h1 className="h4 text-primary mb-4 display-4">
                        Register
                      </h1>
                    </div>
                    <form className="user" onSubmit={signupHandler}>
                      ...
                      <button
                        type="submit"
                        className="mt-3 btn btn-info btn-user btn-block"
                      >
                        Sign up
                      </button>
                    </form>
